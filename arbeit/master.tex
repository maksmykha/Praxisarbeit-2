...
\TitelDerArbeit{Evaluierung des KI-Einsatzes zur nachhaltigen Materialentwicklung mit einem PLM-System }
\AutorDerArbeit{Maksym Mykhailych}
\Abteilung{Product Lifecycle Management/Digital Manufacturing}
\Firma{Capgemini Deutschland GmbH}
\Kurs{TINF24IT1}
\Studienrichtung{Informationstechnik}
\Matrikelnummer{9592553}
\Studiengangsleiter{Prof. Dr. Gerhard Holger}
\WissBetreuer{<Ihr(e) wissenschaftliche(r) Betreuer(in)>}
\FirmenBetreuer{Alexander Zitterbart}
\Bearbeitungszeitraum{14.01.2026 -- DD.MM.YYYY}
...
\input{Grundlage}
\input{Materialentwicklung im industriellen Kontext}
\input{Nachhaltigkeit in der Materialentwicklung}
\input{Methodik der KI-gestützten Materialanalyse}
\input{KI‑gestützte nachhaltige Materialentwicklung}
\input{Evaluierung des KI‑Einsatzes}
\input{chapter2}
